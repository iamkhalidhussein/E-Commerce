...
const About = () => {
  ...
  return (
    <div>
      <p className="text-gray-300 pt-10 pl-20">
        Home /{" "}
        <span className="text-[14px] text-[#000] dark:text-white poppins font-normal">
          About
        </span>
      </p>
      <div className="flex items-center gap-10 py-24 px-20">
        <div>
          <h1 className="text-[#000] dark:text-white text-[50px] font-semibold pb-6">
            Our Story
          </h1>
          <p className="text-[#000] dark:text-white text-base poppins pb-5 font-normal">
          ...
          <p className="text-[#000] dark:text-white text-base poppins font-normal">
        ...
        <img
          className={`rounded w-full ${isLoading && "hidden"}`}
      ...
      <div className="flex gap-7 pt-20 justify-center">
        <div>
          ...
          <h2 className="text-[30px] text-[#000] dark:text-white font-medium pt-3">
            Tom Cruise
          </h2>
          <p className="text-base poppins font-normal text-[#000] dark:text-white pb-2">
            Founder & Chairman
          </p>
        ...
        <div>
          ...
          <h2 className="text-[30px] dark:text-white text-[#000] font-medium pt-3">
            Emma Watson
          </h2>
          <p className="text-base poppins font-normal dark:text-white text-[#000] pb-2">
            Managing Director
          </p>
          <div className="flex gap-2">
            <CiTwitter className="text-xl" />
