      ...
      <div className="md:flex justify-center gap-20 md:mx-0 mx-2 py-24">
        <div className="flex gap-7">
          <div className="">
            ...
            <img
              className="bg-[#F5F5F5] p-4 rounded mb-4 w-[121px] h-[114px]"
              src="https://i.postimg.cc/KvLsX5zt/review-2.png"
              alt="#"
            />
            <img
              className="bg-[#F5F5F5] p-4 rounded mb-4 w-[121px] h-[114px]"
              src="https://i.postimg.cc/B6kNk8fh/review-3.png"
              alt="#"
            />
            <img
              className="bg-[#F5F5F5] p-4 rounded mb-4 w-[121px] h-[114px]"
              src="https://i.postimg.cc/C1qbZm9N/review-4.png"
              alt="#"
            />
          </div>
        ...
        <div>
          ...
          <div className="flex gap-2 items-center py-3">
            ...
            <span className="text-gray-500 font-semibold text-[18px]">
              ...
              <span className="text-[#0F6] poppins text-[14px] font-normal">
                In Stock
              </span>
            </span>
          </div>
          <p className="text-[#000] dark:text-white text-xl font-normal">
            {discount_price}
          </p>
          <p className="text-[14px] poppins dark:text-white text-[#000] font-normal py-4">
          ...
          <p className="text-xl font-normal dark:text-white text-[#000] py-3">
            Colours:
          </p>
          <p className="text-xl font-normal dark:text-white text-[#000] pb-3">
            Size:
          </p>
          ...
          <div className="flex gap-4 items-center">
            ...
            <button className="text-white bg-[#DB4444] py-2.5 px-12 rounded">
              Buy Now
            </button>
          ...
          <div className="border rounded border-[#000] mt-6">
            <div className="flex items-center gap-3 py-3 px-4">
              ...
              <div>
                <p className="text-[#000] dark:text-white poppins text-base font-medium">
                  Free Delivery
                </p>
                <p className="text-[12px] dark:text-white text-[#000] font-medium">
            ...
            <div className="flex items-center px-4 py-3 gap-3">
              ...
              <div>
                ...
                <p className="text-[12px] text-[#000] dark:text-white font-medium">
        ...
        <div key={index} className="flex justify-center pb-10 gap-10">
          <div>
            <div className="relative">
              ...
              <p className="bg-[#000000] absolute bottom-0 w-full text-base poppins font-medium text-[#FFFFFF] py-2.5 text-center rounded-b">
                Add To Cart
              </p>
            </div>
            <h4 className="text-[#000000] text-xl poppins font-semibold pt-3">
