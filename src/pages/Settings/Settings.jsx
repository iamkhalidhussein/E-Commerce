  ...
  return (
    <>
      ...
      <div className="border-2 rounded-md md:px-9 px-3 py-10">
        <h2 className="text-[#FAFAFA] text-2xl work-sans font-semibold">
          Settings
        </h2>
        <p className="text-[#A1A1AA] text-base pb-5 font-normal">
          ...
          <nav className="grid gap-2 mb-10 md:mb-0 work-sans w-3/12">
            {links.map((link) => (
              <Link
                ...
                to={link.to}
                className={clsx(
                  "py-2 pl-4 rounded-md font-medium",
                  location === link.to && "bg-[#27272A]",
                )}
              >
                {link.label}
              </Link>
