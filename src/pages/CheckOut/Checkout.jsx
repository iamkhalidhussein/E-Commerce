  ...
  return (
    <div className="md:flex items-center justify-center gap-28 py-40">
      <div className="md:w-[480px] mx-5">
        <h1 className="text-[#000] dark:text-white text-[32px] font-medium pb-8">
          Billing Details
        </h1>
      ...
      <div className="md:pr-24 md:w-5/12 md:mx-0 mx-4 md:mt-0 mt-5 text-[#000] text-base font-normal poppins">
        ...
        <div className="flex justify-between items-center pt-8">
          ...
          <div className="flex gap-2 items-center">
            ...
            <img
              src="https://i.postimg.cc/KvGMzj8R/mastercard.png"
              alt="mastercard"
            />
...
const RadioOption = ({ label, onClick, defaultChecked }) => {
  return (
    <label
      onClick={onClick}
      className="flex items-center cursor-pointer text-lg pt-3"
    >
      <input
        type="radio"
        name="payment_method"
...
const CouponSection = () => {
  return (
    <div className="flex gap-4 pt-6">
      ...
      />
      <button
        className="bg-[#DB4444] md:py-3 md:px-9 px-6 rounded text-white"
        type="submit"
      >
        Apply Coupon
      </button>
