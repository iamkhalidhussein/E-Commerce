  ...
  return (
    <div className="pt-20 pb-28">
      <div className="flex md:justify-between justify-evenly items-center md:mx-32">
        ...
        <button className="text-[#000] poppins text-base font-medium py-3 px-10 border border-[#000] dark:text-white dark:border-white rounded">
          Move All To Bag
        </button>
      </div>
      ...
      <div className="flex md:justify-between justify-evenly gap-5 md:mx-20 py-24">
        ...
        <button className="py-3 px-12 text-[#000] dark:border-white dark:text-white poppins text-base font-medium rounded border-2">
          See All
        </button>
      </div>
