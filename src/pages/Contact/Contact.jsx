...
const Contact = () => {
  ...
  const iconWrapperClass =
    "bg-[#DB4444] text-white p-[7px] text-4xl rounded-full";
  const titleTextClass =
    "poppins text-base font-medium text-[#000] dark:text-white";
  const paragraphClass =
    "poppins font-normal text-[14px] text-[#000] dark:text-white";
    ...
    <div>
      ...
      <div className="flex justify-center gap-8 pt-28 pb-36">
        <div className="border dark:border-white px-10 py-14 rounded shadow-md">
          ...
          <p className={`${paragraphClass} pb-4`}>
