...
const CashOnDelivery = lazy(
  () => import("../pages/CashOnDelivery/CashOnDelivery"),
);
...
const PaymentCancel = lazy(
  () => import("../Components/PaymentCanceled/PaymentCanceled"),
);
const PaymentFailed = lazy(
  () => import("../Components/PaymentFailed/PaymentFailed"),
);
...
const PasswordSecurity = lazy(
  () => import("../Components/Settings/Password&Security/Password&Security"),
);
const Appearance = lazy(
  () => import("../Components/Settings/Appearance/Appearance"),
);
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://e-commerce-server-inky-alpha.vercel.app/products/flashSalesProducts/${params.id}`,
          ),
      },
      {
        path: "/cashondelivery",
