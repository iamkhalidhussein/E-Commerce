...
const SecurityQuestions = () => {
  const [questions, setQuestions] = useState([
    {
      id: 1,
      question: securityQuestionOptions[0],
      answer: "",
      isEditing: false,
    },
    {
      id: 2,
      question: securityQuestionOptions[2],
      answer: "",
      isEditing: false,
    },
  ]);
  ...
  const handleAddQuestion = () => {
    ...
    const availableQuestion = securityQuestionOptions.find(
    ...
    if (availableQuestion) {
      ...
      toast(
        "Maximum questions reached. You've used all available security questions.",
      );
    }
  };
  ...
  const getAvailableQuestions = (currentQuestion) => {
    ...
    return [
      ...
      ...securityQuestionOptions.filter(
        (q) => !usedQuestions.includes(q) || q === currentQuestion,
      ),
    ];
  };
  return (
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set up security questions to help verify your identity if you forget
            your password.
          </CardDescription>
        </CardHeader>
          ...
          {questions.length === 0 ? (
            <div className="rounded-lg border border-dashed p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Add security questions to help protect your account.
              </p>
            ...
            <>
                      ...
                      <div className="space-y-2">
                        ...
                        {q.isEditing ? (
                          ...
                          >
                            ...
                            <SelectContent>
                              {getAvailableQuestions(q.question).map(
                                (question) => (
              ...
              <div className="rounded-lg border p-3 bg-muted flex gap-3">
                ...
                <div>
                  <p className="text-sm">
                    Security questions are used to verify your identity if you
                    forget your password or need to reset it. Make sure your
                    answers are memorable to you but difficult for others to
                    guess.
                  </p>
                </div>
              </div>
