...
const LogActivity = () => {
  ...
  const getDeviceIcon = (device) => {
    if (device.includes("PC") || device.includes("Mac"))
      return <Laptop2Icon className="h-4 w-4" />;
  ...
  const handleSignOut = (id) => {
    ...
    toast.error(
      "Device signed out The session has been terminated successfully.",
    );
  };

  const handleSignOutAll = () => {
    const currentSession = activities.find(
      (activity) => activity.status === "current",
    );
    setActivities(currentSession ? [currentSession] : []);
    toast.error(
      "All other devices signed out. All other sessions have been terminated successfully.",
    );
  };
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will terminate all active sessions except for your
                    current one. You&apos;ll need to sign in again on those
                    devices.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                ...
                {activities.map((activity) => (
                  <TableRow key={activity.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          activity.status === "current" ? "default" : "outline"
                        }
                      >
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              Detailed information about this login session.
                            </DialogDescription>
                          </DialogHeader>
                          {selectedSession && (
                            <div className="space-y-4 py-2">
                              <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="font-medium">
                                    {formatDate(selectedSession.time)}
                                  </p>
                                </div>
                                <div>
                                  <h4 className="text-sm font-medium text-muted-foreground">
                                ...
                                <div className="rounded-lg border p-3 bg-amber-50 border-amber-200 flex gap-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-amber-700 mt-1">
                                      ...
                                      sign out and change your password
                                      immediately.
                                    </p>
                                  </div>
                                </div>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This will terminate the session on this device.
                            ...
                            <AlertDialogFooter>
                              <AlertDialogCancel>Cancel</AlertDialogCancel>
                              <AlertDialogAction
                                onClick={() => handleSignOut(activity.id)}
                              >
                                Sign Out
                              </AlertDialogAction>
                            </AlertDialogFooter>
