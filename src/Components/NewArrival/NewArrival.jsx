...
const FeaturedItem = ({ image, title, description, linkText, bgColor }) => {
  return (
    <div className="rounded relative" style={{ backgroundColor: bgColor }}>
      ...
      <div className="absolute bottom-9 left-9">
        ...
        <h4 className="text-[#FAFAFA] pt-3 pb-3 text-[14px] font-normal poppins">
          {description}
        </h4>
        <p className="text-[#FFFFFF] text-base font-medium border-b-[1px] w-20">
          {linkText}
        </p>
      </div>
    </div>
