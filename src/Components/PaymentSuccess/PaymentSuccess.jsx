...
const PaymentSuccess = () => {
  const { amount, card_issuer, currency_type, tran_date, tran_id } =
  ...
  return (
    <div className="py-20 border">
      <div className="border dark:border-white md:w-2/5 md:mx-auto mx-2 pt-5 pb-5 rounded-2xl px-10">
        ...
        <h2 className="text-[#121212] dark:text-white poppins text-[30px] pt-1 pb-7 text-center font-semibold">
          {currency_type} {amount}
        </h2>

        <hr className="pb-10 border-t-[2px]" />
        <PaymentSuccessRow title="Transaction ID" tran_id={tran_id} />

        <PaymentSuccessRow title="Payment Time" tran_date={tran_date} />

        <PaymentSuccessRow title="Payment Method" card_issuer={card_issuer} />
...
const PaymentSuccessRow = ({
  ...
  return (
    <div className="flex justify-between mt-4">
      <p className="text-[#707070] dark:text-white text-base poppins font-normal">
        {title}
      </p>
