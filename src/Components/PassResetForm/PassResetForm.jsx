    ...
    <>
      <Dialog>
        <DialogTrigger asChild>
          <p className="mb-8 pt-1 text-[#DB4444] text-[14px] cursor-pointer">
            forget password
          </p>
        </DialogTrigger>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter email address for resetting your password. A password reset
          ...
          <DialogFooter>
            <Button type="submit" onClick={() => handleForgetPass()}>
              Reset
            </Button>
          </DialogFooter>
        </DialogContent>
