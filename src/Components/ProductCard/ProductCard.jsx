...
export const ProductCard = ({
  ...
  return (
    <div className="mx-auto">
      ...
      <ProductPrice discount_price={discount_price} main_price={main_price} />
      <ProductRating
        ratings={ratings}
  ...
  return (
    <div className="relative">
      ...
      <p
        ...
        className="bg-[#000000] absolute bottom-0 w-full text-base poppins select-none font-medium text-[#FFFFFF] py-2.5 text-center rounded-b"
      >
        Add To Cart
      </p>
    </div>
